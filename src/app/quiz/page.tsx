        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid lg:grid-cols-4 gap-12">
            <div className="lg:col-span-2">
              <img src="/logo.png" alt="TDE" className="h-16 w-auto object-contain mb-6" />
              <p className="text-gray-600 leading-relaxed max-w-lg">{t('footer_desc')}</p>
            </div>
            <div>
              <h4 className="font-bold text-[#1f2d3d] mb-6">{t('footer_platform')}</h4>
            ...
            <div>
              <h4 className="font-bold text-[#1f2d3d] mb-6">{t('footer_contact')}</h4>
              <div className="space-y-4 text-gray-600">
                <p>+57 314 399 2911</p>
                <p>info@tde.com.co</p>
                <p>Bogota, Colombia</p>
